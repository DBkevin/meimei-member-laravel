<?php
namespace App\Filament\Resources\MemberResource\RelationManagers; use App\Models\Showcase; use Filament\Resources\RelationManagers\RelationManager; use Filament\Tables; use Filament\Tables\Table; use Filament\Tables\Columns\BadgeColumn; use Filament\Tables\Columns\IconColumn;
class ShowcasesRelationManager extends RelationManager { protected static ?string $title = '案例素材'; protected static ?string $modelLabel = '案例'; protected static string $relationship = 'showcases'; public function table(Table $table): Table { return $table->columns([
    ...
    Tables\Columns\TextColumn::make('doctor.name')->label('医生'),
    ...
    IconColumn::make('usable_for_article')->label('公众号')->boolean(),
    IconColumn::make('usable_for_xiaohongshu')->label('小红书')->boolean(),
])->paginated(10); }
}
